...
const Type = (props) => {
  ...
  return (
    <div id = "product-description">
        ...
        <><label htmlFor = 'DVD_discs'>Size (MB) </label><input type = 'text' id = 'size' name = 'size' onChange = { props.handleChange } /></>
        : (props.type === "Books") ? 
        <><label htmlFor = 'books'>Weight (KG) </label><input type = 'text' id = 'weight' name = 'weight' onChange = { props.handleChange } /></>
        : <><div id = 'Furniture'>
